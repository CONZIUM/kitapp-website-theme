  ...
  return (
    <>
      <Router>
        <ScrollTopBehaviour />
        <Switch>
          <Route exact path='/' component={MobileAppLanding} />
          ...
          <Route path='/product-customer-support' component={ProductCustomerSupport} />
          <Route path='/features-customer-support' component={FeaturesCustomerSupport} />
